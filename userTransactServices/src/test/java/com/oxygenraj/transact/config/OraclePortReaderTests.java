...
class OraclePortReaderTests {
    ...
    private final OraclePortReader.ConnectionFactory connections =
            mock(OraclePortReader.ConnectionFactory.class);
    ...
    @Test
    void readsTheExactServiceSettingUsingThePropertiesAccountAndBoundedTimeouts() throws SQLException {
        ...
        assertThat(OraclePortReader.PORT_QUERY.strip()).startsWith("SELECT ")
        ...
        verify(statement).setString(1, "userTransactServices");
    ...
    void failsClosedForAMissingRowAndClosesResources() throws SQLException {
        ...
        assertThat(failure).hasMessageContaining("Missing EUREKA_DB.PROPERTIES row")
                .hasMessageContaining("userTransactServices / jdbc / jdbc / server.port");
        assertAllJdbcResourcesClosed();
    }
    ...
    void closesTheConnectionWhenPreparingTheStatementFails() throws SQLException {
        when(connection.prepareStatement(OraclePortReader.PORT_QUERY)).thenThrow(sensitiveSqlException(942));
